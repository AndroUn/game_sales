...
[
    ...
    {id: randomNumber(), img: '../img/games/dfxemr0-843a931b-f430-4719-86c7-75f126a77340 (1).png', title: "Mortal Kombat 1", platform: 'PS5', price: '199'},
    ...
    {id: randomNumber(), img: '../img/games/Resident_Evil_4_remake_cover_art.jpg', title: 'Resident Evil 4 Remake', platform: 'PS5', price: '150'},
    {id: randomNumber(), img: '../img/games/oVxOoP4w_400x400.jpg', title: 'Lies Of P', platform: 'PS5', price: '199'},
...
[
    {id: randomNumber(), img: '../img/accessories/dualsense-controller-product-thumbnail-01-en-14sep21.webp', title: 'DualSense™ Wireless Controller', descr: 'Immerse yourself in the gaming experience with a controller the supports responsive haptic feedback and dynamic trigger effects.',price: '150'},
    {id: randomNumber(), img: '../img/accessories/sony-playstation-5.png', title: 'PlayStation 5 Console', descr: 'Experience an all-new generation of incredible PlayStation games. PS5 consoles are currently in stock.',price: '1500'},
    {id: randomNumber(), img: '../img/accessories/3d-pulse-headset-product-thumbnail-01-en-14sep21.webp', title: 'PULSE 3D™ Wireless Headset', descr: 'Enjoy a seamless wireless experience with a headset fine-tuned for 3D Audio on PS5 consoles.',price: '250'},
    {id: randomNumber(), img: '../img/accessories/kamera-sony-playstation-5-hd-camera-5920-940x480.jpg', title: 'Playstation HD Camera', descr: 'Add yourself to your gameplay videos and broadcasts with smooth, sharp, full-HD capture.',price: '120'},
]
